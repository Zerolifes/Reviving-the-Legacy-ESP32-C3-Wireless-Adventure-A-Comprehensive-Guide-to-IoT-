...
#define LIGHT_ESP_WIFI_SSID     "khongsochet"
...
static void esp_local_ctrl_service_start(void)
{
    ...
    https_conf.servercert = cacert_pem_start; // origianl: https_conf.cacert_pem = cacert_pem_start;
    https_conf.servercert_len = cacert_pem_end - cacert_pem_start; // original: https_conf.cacert_len = cacert_pem_end - cacert_pem_start;
